...
bedtools intersect -a sv_sorted.bed -b loop_anchor_1_sorted.bedpe -wa -wb > 877sv_loop_anchor1.xls
bedtools intersect -a sv_sorted.bed -b loop_anchor_2_sorted.bedpe -wa -wb > 877sv_loop_anchor2.xls
